...
void PlayScene::Draw()
{
	...
	if(m_bDebugView)
	{
		...
		if(m_pStarShip->IsEnabled())
		{
			...
			//draw whiskers
			Util::DrawLine(m_pStarShip->GetTransform()->position, m_pStarShip->GetLeftLOSEndPoint(), m_pStarShip->GetLineColour(0));
			Util::DrawLine(m_pStarShip->GetTransform()->position, m_pStarShip->GetMiddleLOSEndPoint(), m_pStarShip->GetLineColour(1));
			Util::DrawLine(m_pStarShip->GetTransform()->position, m_pStarShip->GetRightLOSEndPoint(), m_pStarShip->GetLineColour(2));
...
void PlayScene::Update()
{
	...
	if(m_pStarShip->IsEnabled())
	{
		...
		CollisionManager::CircleAABBCheck(m_pStarShip, m_pObstacle);
		...
		//e whisk
		m_pStarShip->GetCollisionWhiskers()[0] = CollisionManager::LineRectCheck(m_pStarShip->GetTransform()->position, m_pStarShip->GetLeftLOSEndPoint(), boxStart, boxWidth, boxHeight);
		m_pStarShip->GetCollisionWhiskers()[1] = CollisionManager::LineRectCheck(m_pStarShip->GetTransform()->position, m_pStarShip->GetMiddleLOSEndPoint(), boxStart, boxWidth, boxHeight);
		m_pStarShip->GetCollisionWhiskers()[2] = CollisionManager::LineRectCheck(m_pStarShip->GetTransform()->position, m_pStarShip->GetRightLOSEndPoint(), boxStart, boxWidth, boxHeight);
